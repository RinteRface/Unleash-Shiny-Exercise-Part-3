...
Now onto the `renderBox` function. As we've explored, it should itself return a `function`, this function should send the path to the JavaScript binding so it can be read and generate the output. The only problem is that it is not done, no response is served: use `shiny:::httpResponse` below to fix that.
...
Test the custom output: fingers' crossed!
